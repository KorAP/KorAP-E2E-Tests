...
want to get notified about failed tests via slack, set the environment variable `SLACK_WEBHOOK_URL` to the URL of your slack webhook and `SLACK_CHANNEL` to the channel you want to post to.
